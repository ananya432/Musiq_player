...
//             ],
//           ),
//           Padding(padding:EdgeInsets.only(right:8,left:15),
//           child:Icon(
...
//   @override
//   Widget build(BuildContext context) {
//     return ListView.builder(itemCount: mostpopular.length, itemBuilder: (BuildContext context, int index){
//       return Container(margin:EdgeInsets.all(10),
//       width:200,
//       decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
//       boxShadow: [BoxShadow(color:mostpopular[index].color, blurRadius:1,spreadRadius: 0.3)
//       ],
